	...
	<div class="box-body table-responsive"> 
		...
		<form action="create" accept-charset="utf-8" method="post">
		    <div class="form-group">
		        ...
		        <input type="text" class="form-control" name="aktivitas" id="aktivitas" placeholder="Nama Aktifitas..."/>
		    </div>

		    <div class="form-group">
				<label for="deskripsi">Deskripsi</label>
				<textarea name="deskripsi" class="form-control" placeholder="Deskripsi Aktifitas..."></textarea>
		    </div>
